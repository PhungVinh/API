...
{
    public class VOCCommon
    {
        public static List<TblConnectionConfig> ListConnectionStrings { get; set; }
        public List<List<dynamic>> GetAllConnection()
        {
            return ExecuteMultipleResults(VOCConstant.MASTER_STORE_PROC, null, VOCConstant.SQL_CONNECTION, typeof(TblConnectionConfig));
        }
