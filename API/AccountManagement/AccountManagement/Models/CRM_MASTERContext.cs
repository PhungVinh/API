    ...
    public partial class CRM_MASTERContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //                    .AddJsonFile(AccountConstant.FileAppsettingsJson)
                //                    .Build();
                optionsBuilder.UseSqlServer(AccountConstant.SQL_CONNECTION);
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblOrganization>(entity =>
            {
                ...
                entity.Property(e => e.OrganizationAddress).HasMaxLength(255);
        ...
        public object GetMenuByRole(int roleId)
        {
            ...
            try
            {
                ...
                string sqlQuery = "EXEC [dbo].[sp_LoadMenu] " +
                                    "@RoleId";
                lst = Query<TblMenuSP>().FromSql(sqlQuery, usernameParam).ToListAsync().Result;
            }
            catch (Exception ex)
            {
                throw ex;
