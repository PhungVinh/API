...
namespace VinhDemo.Controllers
{
    ...
    public class OrganizationController : Controller
    {
        ...
        #region SearchUserVinhDemo phân trang @vinhnp
        /// <summary>
        /// SearchUserVinhDemo
        /// </summary>
        /// <param name="textSearch"></param>
        ...
        /// <param name="recordperpage"></param>
        /// <returns></returns>
        [Route("~/api/OrganizationVinh/SearchUserVinhDemo")]
        [HttpGet]
        [Authorize]
        public object SearchUserVinhDemo(string textSearch, int currPage, int recordperpage)
        {
            var data = _iOrganizationRepository.SearchUserVinhDemo(textSearch, currPage, recordperpage);
            return data;
        }
        #endregion
