...
namespace OrganizationManagement.DataAccess
{
    public class SP_OrganizationDA: IObjectContextAdapter
    {
        ...
        #region Hàm SearchLogUser
        /// <summary>
        /// SearchLogUser to stored procedure
        /// </summary>
        /// <param name="textSeach"></param>
        /// <param name="currentPage"></param>
        /// <param name="recordPerPage"></param>
        /// <returns></returns>
        public List<List<dynamic>> SearchLogUser(string textSeach, int currentPage, int recordPerPage)
        {
            SqlParameter[] para = new SqlParameter[3];
            para[0] = new SqlParameter("@TextSearch", textSeach);
            para[1] = new SqlParameter("@currPage", currentPage);
            para[2] = new SqlParameter("@recordperpage", recordPerPage);
            return ExecuteMultipleResults("sp_SearchLogUser", para, OrganizationConstant.SQL_CONNECTION, typeof(LogUserVM), typeof(PagePaging));

        }
        #endregion

        #region Hàm SearchCategory 
        /// <summary>
        /// SearchCategory to stored procedure
        /// </summary>
        /// <param name="textSeach"></param>
        /// <param name="currentPage"></param>
        /// <param name="recordPerPage"></param>
        /// <returns></returns>
        public List<List<dynamic>> SearchCategory (string textSearch, int currentPage, int recordPerPage)
        {
            SqlParameter[] para = new SqlParameter[3];
            para[0] = new SqlParameter("@TextSearch", textSearch);
            para[1] = new SqlParameter("@currPage", currentPage);
            para[2] = new SqlParameter("@recordperpage", recordPerPage);
            return ExecuteMultipleResults("sp_SearchCategory", para, OrganizationConstant.SQL_CONNECTION, typeof(CategoryVM), typeof(PagePaging));
        }
        #endregion

        #region  SearchUserVinhDemo
        /// <summary>
        /// SearchUserVinhDemo
        /// </summary>
        ...
        /// <param name="recordPerPage"></param>
        /// <returns></returns>
        public List<List<dynamic>> SearchUserVinhDemo (string textsearch, int currentPage, int recordPerPage)
        {
            SqlParameter[] para = new SqlParameter[3];
            para[0] = new SqlParameter("@TextSearch", textsearch);
            para[1] = new SqlParameter("@currPage", currentPage);
            para[2] = new SqlParameter("@recordperpage", recordPerPage);
            return ExecuteMultipleResults("sp_SearchUserVinhDemo", para, OrganizationConstant.SQL_CONNECTION, typeof(UserVinhDemoVM), typeof(PagePaging));
        }
        #endregion
    }
}
